...
const RegistroConstruccion = () => {
  ...
  return (
    <div>
      <p>
        Muro de contencion SUR. Se cooperan seis hermanos: Lucia, Isabel, Abraham,
        Maximina, Alejandra y Agustina. Los albañiles comenzaron a trabajar el
        día: Lunes 17 de Julio del 2023.
      </p>
      ...
      <button className="primary-button" onClick={() => capturarTabla(tablaRefCronologica.current)}>
        Capturar tabla
      </button>
          ...
          <div key={tipo}>
            <table>
              ...
              <tfoot>
                <tr>
                  <td></td>
                  <td colSpan={2}>Balance: ${Math.abs(balance).toFixed(2)}</td>
                  <td colSpan={2}>
                    Entre 6: ${(Math.abs(balance) / 6).toFixed(2)}
                  </td>
                </tr>
              </tfoot>
            </table>
      ...
      <button className="primary-button" onClick={() => capturarTabla(tablaRefPorTipo.current)}>
        Capturar tabla
      </button>
      <hr></hr>
      <h3>Faenas</h3>
      ...
      <button className="primary-button" onClick={() => capturarTabla(tablaRefFaenas.current)}>
        Capturar tabla
      </button>
      ...
      <div>
        ...
        <button className="primary-button" onClick={() => capturarTabla(tablaRefPagoFaenas.current)}>
          Capturar tabla
        </button>
      </div>
    </div>
